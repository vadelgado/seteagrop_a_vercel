...
@ganaderia.route("/ganaderia")
def ganaderia_productos():
    """Función para mostrar los productos de ganadería"""
    data = {
        "titulo": "Ganadería",
    }
    ...
    if productos_paginados is not None:
        return render_template("ganaderia/ganaderia.html", data=data, productos=productos_paginados)
    else:
